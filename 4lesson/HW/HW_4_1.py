...
# на круглой грядке, причем кусты высажены тоько по окружности.
# Таким образом, у каждого куста есть ровно два сосседних. Всего
# на грядке растет N кустов. Эти кусты обладают разной урожайностью,
# поэтому ко времени сбора на них выросло раличное число ягод - на i-ом 
